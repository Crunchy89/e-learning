			...
			<form id="form">
				<div class="modal-body">
					<div class="form-group">
						...
						<input type="text" name="jurusan" id="jurusan" class="form-control form-control-sm" placeholder="Nama Jurusan" required>
					</div>
					<div id="add">
					</div>
				</div>
