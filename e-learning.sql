...
(2, 'Ferdy', '$2y$10$pcO3OiCmSrppHTVEQxExQugFF/adnL65Wxfeit4aVRiKR4pInDILS', 3, 1);
...
(2, 'Menu Guru', 'fas fa-fw fa-user-graduate', 1, 3),
(3, 'Menu TU', 'fas fa-fw fa-file', 1, 4),
(6, 'Dashboard', 'fas fa-fw fa-tachometer-alt', 1, 1),
(7, 'Menu Siswa', 'fas fa-fw fa-users', 1, 5);
...
(6, 1, 'Access Management', 'fas fa-fw fa-lock-open', 'access', 1),
(7, 2, 'Materi', 'fas fa-fw fa-book', 'materi', 1),
(12, 6, 'Dashboard', 'fas fa-fw fa-tachometer-alt', 'admin/dashboard', 1),
(13, 3, 'Data Guru', 'fas fa-fw fa-user', 'guru', 1),
(14, 3, 'Data Siswa', 'fas fa-fw fa-user', 'siswa', 1),
(15, 3, 'Data Jurusan', 'fas fa-fw fa-user', 'jurusan', 1),
(16, 3, 'Data Kelas', 'fas fa-fw fa-user', 'kelas', 1);
...
--
ALTER TABLE `user_access`
  MODIFY `id_access` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=49;
--
